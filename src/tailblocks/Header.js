...
export class Header extends Component {
      ...
      <div class="flex flex-col w-full pt-0 mb-16 text-left lg:flex-grow md:w-1/2 xl:mr-20 md:pr-24 md:items-start md:mb-0">
        ...
        <div class="flex flex-wrap -mx-4 -mt-4 -mb-10 sm:-m-4">
          <div class="flex flex-col items-start p-4 mb-6 text-left md:w-1/2 md:mb-0">
            <div class="inline-flex items-center justify-center flex-shrink-0 w-12 h-12 mb-5 text-white bg-blue-700 dark:bg-blue-400 shadow rounded-full p-2">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
            ...
            <div class="flex-grow">
              ...
              <p class="text-base leading-relaxed mb-4">100+ Components available for your projects.Decide to choose next.</p> <Link to="lightcomp" class="inline-flex items-center dark:text-blue-400 text-blue-700 md:mb-2 lg:mb-0 hover:text-blue-800">
                Learn More
                <svg
                  class="w-4 h-4 ml-2"
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 13v-1m4 1v-3m4 3V8M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
            ...
            <div class="flex-grow">
              ...
              <p class="text-base leading-relaxed mb-4">React templates using light theme.Explore and choose to create next project.</p> <Link to="lightcomp" class="inline-flex items-center dark:text-blue-400 text-blue-700 md:mb-2 lg:mb-0 hover:text-blue-800">
                Learn More
                <svg
                  class="w-4 h-4 ml-2"
                  xmlns="http://www.w3.org/2000/svg"
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 13v-1m4 1v-3m4 3V8M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
      ...
      <div class="w-full lg:w-5/6 lg:max-w-lg md:w-1/2">
        <img class="object-cover object-center rounded-lg" alt="hero" src="https://ik.imagekit.io/vpa3fwqdnd/Components/Hinterrhein_JgUb_ltVI.svg" />
      </div>
    </div>
  </section>
