              ...
              <div className="h-full rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <Link to="" className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 " href="/detail">Learn More
          ...
          <div className="-my-8">
            <div className="py-8 px-4 flex flex-wrap md:flex-nowrap">
              ...
              <div className="md:flex-grow">
                ...
                <Link to="" className="text-indigo-500 inline-flex items-center mt-4 " href="/detail">Learn More
                  <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M5 12h14" />
                    <path d="M12 5l7 7-7 7" />
                  </svg>
