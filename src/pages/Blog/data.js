...
export const BlogData = [
    ...
    So open the Command prompt and install</p>
     <p class="bg-gray-800 px-2 py-2 rounded overflow-y-scroll scroll-hidden overflow-auto">
    pip install django
     </p>
    ...
    <div class="bg-gray-800 px-2 py-2 rounded overflow-y-scroll scroll-hidden overflow-auto">
    import django
    <p>
...
,
...

    {
      ...
      body:"dfsdgdf dfgdfgds f gdsjgds gds,gjdsg",
    },
