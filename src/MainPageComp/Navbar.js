      ...
      <div className="font-bold bg-white shadow dark:bg-gray-900 dark:bg-opacity-90 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-12">
          <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
            ...
            <Link to="/" className="text-3xl font-bold text-blue-700 dark:text-white">
            ...
            <nav className="hidden md:flex space-x-10">
              ...
              {Nav.map((data,key)=>
                  <Link to={data.url} key={data.name} className="text-gray-800 dark:text-white  group inline-flex items-center text-base hover:text-black dark:hover:text-gray-200 focus:outline-none font-extrabold px-4 py-2">
                  <span>{data.name}</span>
                </Link> )}
              </div>
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <p className="ml-8 whitespace-nowrap inline-flex items-center justify-center">
              <Toggle/>
              </p>
            </div>
          </div>
