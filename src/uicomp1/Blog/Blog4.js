...
export class Blog4 extends Component {
    render() {
        return (
            <div>
                 <main className="mt-12 max-w-screen-lg mx-auto">
    
        <div className="flex mt-16 mb-4 px-4 lg:px-0 items-center justify-between">
          <h2 className="font-bold text-3xl">Latest news</h2>
          <a href="/" className="bg-gray-200 hover:bg-green-200 text-gray-800 px-3 py-1 rounded cursor-pointer">
            View all
          </a>
        </div>
        <div className="block space-x-0 lg:flex lg:space-x-6">
          <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
            <img alt="" src="https://images.unsplash.com/photo-1526666923127-b2970f64b422?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" className="rounded" />
          ...
          <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
            <img alt="" src="https://images.unsplash.com/photo-1504384764586-bb4cdc1707b0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" className="rounded" />
            <div className="p-4 pl-0">
          ...
          <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
            <img alt="" src="https://images.unsplash.com/photo-1483058712412-4245e9b90334?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80" className="rounded"  />
            <div className="p-4 pl-0">
