...
export class Blog6 extends Component {
    render() {
        ...
        <div className="mb-4 md:mb-0 w-full mx-auto relative">
          ...
          <img alt="" src="https://images.unsplash.com/photo-1587614387466-0a72ca909e16?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80" className="w-full object-cover lg:rounded" style={{height: '28em'}} />
        </div>
