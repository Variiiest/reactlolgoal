...
<div className="wrapper bg-gray-800 rounded-sm shadow-lg">
  <div className="px-8 py-4">
    <div className="-mt-10 mb-6">
      <svg className="w-20 h-20 text-green-300 fill-current" xmlns="http://www.w3.org/2000/svg" width={512} height="512.002" viewBox="0 0 512 512.002">
    ...
    <div className="">
      <h1 className="text-xl md:text-2xl font-bold leading-tight text-gray-100">Lorem Ipsum Dolar Sit , amet Consecturer adipisicing</h1>
      <p className="text-base md:text-lg text-green-200 mt-3 ">Lorem Ipsum Dolar Sit , amet Consecturer adipisicing</p>
    </div>
    <div className="flex items-center my-10">
    
    <div className="bg-gray-900 shadow-2xl rounded-lg">
              <div className="px-4 py-4">
                <div className="flex flex-col">
                  <h4 className="text-lg font-semibold mb-3">Lorem Ipsum Dolar Sit , amet Consecturer adipisicing</h4>
