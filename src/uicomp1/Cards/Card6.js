        ...
        <div className="wrapper bg-white rounded-sm shadow-lg">
          <div className="card px-8 py-4">
            <div className="card-image mt-10 mb-6">
              <svg className="w-10 h-10 text-orange-500 fill-current" xmlns="http://www.w3.org/2000/svg" width={512} height="512.002" viewBox="0 0 512 512.002">
            ...
            <div className="card-text">
              <h1 className="text-xl md:text-2xl font-bold leading-tight text-gray-900">Get the latest components right into your inbox!</h1>
            ...
            <div className="card-mail flex items-center my-10">
              ...
              <button className="bg-orange-500 hover:bg-orange-600 hover:border-orange-600 text-white font-bold capitalize px-3 py-2 text-base md:text-lg rounded-r-md border-t border-r border-b border-orange-500">subscribe</button>
            </div>
          </div>
        </div>
      </div>
