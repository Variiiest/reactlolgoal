          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-4 ">
              ...
              <div className="p-2 bg-white shadow rounded">
                <img className="h-40 rounded w-full object-contain object-center mb-2 border" src={this.props.image1} alt="content" />
            ...
            <Link to={this.props.thirdl}>
              <div className="p-2 bg-white shadow rounded">
                <img className="h-40 rounded w-full object-cover object-center mb-2 border" src={this.props.image3} alt="content" />
            ...
            <Link to={this.props.fourthl}>
              <div className="p-2 bg-white shadow rounded">
                <img className="h-40 rounded w-full object-contain object-center mb-2 border" src={this.props.image4} alt="content" />
