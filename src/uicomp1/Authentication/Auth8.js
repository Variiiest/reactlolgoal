...
export class Auth8 extends Component {
    render() {
        return (
            <div>
                  <section className="flex flex-col items-center text-gray-900  md:flex-row ">
      
        <div className="flex w-full px-6 bg-white md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 lg:px-16 xl:px-12 items-left justify-left">
          <div className="w-full py-32 lg:py-6 lg:h-100">
            ...
            <form className="mt-6" action="#" method="POST">
              <div>
                <label className="text-xs font-medium leading-relaxed tracking-tighter text-gray-700">Email
                  Address</label>
                <input type="email" name="" id="email_address" placeholder="Your Email " className="w-full px-4 py-2 text-base rounded-lg focus:border-gray-500 focus:outline-none border" autoComplete=""/>
              </div>
              <div className="mt-4">
                <label className="text-xs font-medium leading-relaxed tracking-tighter text-gray-700">Password</label>
                <input type="password" name="" id="password" placeholder="Your Password" minLength={6} className="w-full px-4 py-2 text-base rounded-lg focus:border-gray-500 focus:outline-none border" required />
              </div>
              <div className="mt-2 text-right">
                <a href="/" className="text-sm font-semibold leading-relaxed text-gray-700 hover:text-gray-900 focus:text-gray-900">Forgot
                  Password?</a>
              </div>
              <button type="submit" className="w-full px-4 py-3 mt-6 font-semibold text-white bg-blue-900 rounded-lg focus:outline-none ">Log
                In</button>
            </form>
