          ...
          <div className="bg-white shadow-2xl w-full rounded divide-y divide-gray-200">
            <div className="px-5 py-7">
              ...
              <input type="email"
                ...
                autoComplete="Email Address" className="border-2 focus:outline-none hover:border-blue-500 rounded px-4 py-3 mt-1 mb-5 text-sm w-full"/>
              <label className="font-semibold text-sm text-gray-600 pb-1 block">Password</label>
              <input  type="password"
                id="password"
                name="password"
                placeholder="Password"
                autoComplete="current password" className="focus:outline-none hover:border-blue-500 rounded px-4 py-3 mt-1 mb-5 text-sm w-full border-2" />
