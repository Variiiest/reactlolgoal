    ...
    render() {
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row">
            <div className="w-full bg-cover lg:w-6/12 xl:w-7/12">
              <div className="flex flex-col items-center justify-center w-full h-full px-10 my-20 lg:px-16 lg:my-0">
                <div className="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
                  ...
                  <a href="#_" className="inline-block px-4 py-2 text-base font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700">Get Started Today</a>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                ...
                <div className="w-full mt-10 space-y-8">
                  <div className="">
                    ...
                    <input type="text" className="block w-full px-4 py-2 mt-2 text-base border rounded-lg focus:outline-none " placeholder="Enter Your Name" />
                  </div>
                  <div className="">
                    <label className="font-medium text-gray-900">Email</label>
                    <input type="text" className="block w-full px-4 py-2 mt-2 text-base border rounded-lg focus:outline-none" placeholder="Enter Your Email Address" />
                  </div>
                  <div className="">
                    <label className="font-medium text-gray-900">Password</label>
                    <input type="password" className="block w-full px-4 py-2 mt-2 text-base border rounded-lg focus:outline-none" placeholder="Password" />
                  </div>
                  <div className="">
