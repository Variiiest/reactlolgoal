    ...
    render() {
        return (
            <div>
                      ...
                      <section className="text-gray-200 body-font px-2 font-bold secondcolr">
            ...
            <div className="flex flex-wrap -mx-4 -mt-4 -mb-10 sm:-m-4">
              <div className="flex flex-col items-start p-4 mb-6 text-left md:w-1/2 md:mb-0 ">
                ...
                <div className="flex-grow ">
                  <h2 className="mb-3 text-lg font-bold tracking-tighter text-white title-font">
                    Information 1
                  </h2>
                  <p className="text-base leading-relaxed">Explain 2 great feature here. Information about the
                    feature.
                  </p>
                  <a href="/" className="inline-flex items-center font-semibold text-blue-300 md:mb-2 lg:mb-0 hover:text-blue-400 ">
                    Learn More
