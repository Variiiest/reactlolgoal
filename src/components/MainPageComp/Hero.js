...
<section className="text-gray-800 body-font">
      <div className="container max-w-7xl mx-auto flex px-5 py-24 items-center justify-center flex-col">
        <div className="flex flex-wrap items-center pb-12 bg-gradient-to-b from-gray-100 to-gray-50 rounded-xl sm:px-5 py-12 px-2">
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
            <img className="absolute w-full h-full inset-0 object-cover object-center rounded-md" src="https://ik.imagekit.io/vpa3fwqdnd/Components/photo-1606857521015-7f9fcf423740_8UZOBTPSb.jpg" alt="" />
            <div className="relative z-10 bg-white rounded-md shadow border p-6 w-10/12 -mb-20 transform skew-y-6">
