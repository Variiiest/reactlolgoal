             ...
             <div className="container flex flex-col items-center px-5 py-16 mx-auto md:flex-row lg:px-28">
               <div className="flex flex-col items-start w-full pt-0 mb-16 text-center lg:flex-grow xl:mr-10 md:pr-12 md:mb-0 ">                        
                 <div className="flex flex-wrap w-full mt-2 -mx-4 text-center">
                   ...
                   <div className="inline-flex items-center justify-center flex-shrink-0 sm:w-32  sm:h-32 w-16 h-16 mb-5 text-gray-900 bghero2 shadow rounded-full">
...
<section className="text-blue-800 body-font font-bold">
        <div className="container mx-auto py-6 px-4">
          <div className="flex flex-wrap">
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="p-6 rounded-md bghero2 shadow-xl hover:shadow-2xl">
                <h2 className="text-2xl text-blue-800 font-bold title-font mb-2">Web Development</h2>
                <p className="leading-relaxed text-base text-gray-800">We develop web applications that engaging, and are developed with the latest technologies.And If you are programming person use our code snippets for free.</p>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4 ">
              <div className=" p-6 rounded-md bghero2 shadow-xl hover:shadow-2xl">
                ...
                <h2 className="text-2xl text-blue-800 font-bold title-font mb-2">Free Landing Pages</h2>
                <p className="leading-relaxed text-base text-gray-800">We have  developed some landing pages with latest technologies . If you are starting a startup,Landing pages are important.We also matched the color with industry.</p>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4 ">
              <div className=" p-6 rounded-md bghero2 shadow-xl hover:shadow-2xl">
                <h2 className="text-2xl text-blue-800 font-bold title-font mb-2">Frontend Templates Premium </h2>
                <p className="leading-relaxed text-base text-gray-800">We have  developed some landing pages with latest technologies . If you are starting a startup,Landing pages are important.We also matched the color with industry.</p>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4 ">
              <div className=" p-6 rounded-md bghero2 shadow-xl hover:shadow-2xl">
                ...
                <h2 className="text-2xl text-blue-800 font-bold title-font mb-2">Free FullStack Projects</h2>
                <p className="leading-relaxed text-base text-gray-800">Our free fullstack projects help you to start business with less cost.Also Get assistant for hosting and choosing right domain.</p>
                <Link to="/freetemp" className="text-blue-600 inline-flex items-center mt-4">Learn More
                  <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M5 12h14" />
                    <path d="M12 5l7 7-7 7" />
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4 ">
              <div className=" p-6 rounded-md bghero2 shadow-xl hover:shadow-2xl">
                ...
                <h2 className="text-2xl text-blue-800 font-bold title-font mb-2">Full-Stack Premium</h2>
                <p className="leading-relaxed text-base text-gray-800">Our free fullstack projects help you to start business with less cost.Also Get assistant for hosting and choosing right domain.</p>
                <Link to="/premium" className="text-blue-600 inline-flex items-center mt-4">Learn More
                  <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M5 12h14" />
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className=" p-6 rounded-md bghero2 shadow-xl hover:shadow-2xl">
                <h2 className="text-2xl text-blue-800 font-bold title-font mb-2">Custom Development</h2>
                <p className="leading-relaxed text-base text-gray-800">Try our free resources , If not working for your project just contact us. We will work with you and help you to start your business.
</p>
