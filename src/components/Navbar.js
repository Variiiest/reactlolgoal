...
export class Navbar extends Component {
  ...
  render() {
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10 ">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <a href="/" className="text-3xl font-bold  secondcolor">
      ...
      <section className={"text-gray-800 body-font py-12 border-t bg-red-200"+( this.state.openList1 ? "" : " hidden")} onMouseLeave={()=>this.setListOpen1()}>
      ...
      <section className={"text-gray-800 body-font border-t"+( this.state.openList2 ? "" : " hidden")} onMouseLeave={()=>this.setListOpen2()}>
