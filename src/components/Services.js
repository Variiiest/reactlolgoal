...
<div className="py-12 bg-gradient-to-r from-pink-800 via-gray-800 to-gray-900">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="mt-10">
      <dl className="space-y-5 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
        <div className="relative bg-gradient-to-r from-gray-900 to-black shadow-lg py-2 px-2 rounded-2xl">
          <dt>
