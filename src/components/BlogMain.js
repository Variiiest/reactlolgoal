  ...
  <section className="text-gray-300 bg-black body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col w-full text-center lg:mb-20">
            ...
            <p className="w-full mx-auto mb-8 text-xl font-light text-center text-white text-opacity-60 lg:text-center">
              Tailwind
              CSS
              templates
              ...
              <div className="h-full bg-gradient-to-r from-gray-900 to-black items-left rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <a href="/" className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">Learn More
