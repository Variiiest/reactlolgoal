        ...
        <div className="container py-10 mx-auto">
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
              <h1 className="ml-8 text-gray-900 font-medium title-font text-4xl border-b-2 border-green-400 mb-2 sm:mb-0">Education</h1>
            
            </div>
          </div>
          <div className="flex flex-wrap -p-4 -mb-10 -mt-4">
          ...
          <div className="p-4 md:w-1/4 sm:mb-0 mb-6 ">
              ...
              <p className="text-base leading-relaxed mt-2">Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. .</p>
              <a href="/" className="secondcolor inline-flex items-center mt-3">Learn More
