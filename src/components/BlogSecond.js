        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
              <h1 className="ml-2 text-gray-900 font-medium title-font text-4xl border-b-2 border-green-400 mb-2 sm:mb-0">Education</h1>
            
            </div>
          </div>
          <div className="flex flex-wrap -p-4 -mb-10 -mt-4 bg-white rounded-md shadow-lg">
