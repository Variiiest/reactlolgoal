...
export class Page11 extends Component {
    render() {
        return (
          ...
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
              <a href="#_" className="mr-5 hover:text-gray-900">First Link</a>
              <a href="#_" className="mr-5 hover:text-gray-900">Second Link</a>
              <a href="#_" className="mr-5 hover:text-gray-900">Third Link</a>
              <a href="#_" className="mr-5 hover:text-gray-900">Fourth Link</a>
            </nav>
        ...
        <section className="w-full px-6 antialiased bg-blue-100">
          <div className="mx-auto max-w-7xl">
            <div className="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
              <h1 className="text-4xl font-extrabold leading-10 tracking-tight text-left text-gray-800 md:text-center sm:leading-none md:text-6xl lg:text-7xl">
              ...
              <div className="mx-auto mt-5 text-lg text-gray-600 md:mt-12 md:max-w-2xl md:text-center lg:text-2xl">
        ...
        <section className="body-font bg-blue-100 text-gray-700">
          <div className="container px-8 py-24 mx-auto flex flex-wrap">
            <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
              <div className="w-full sm:p-4 px-4 mb-6">
                <h1 className="mb-12 mt-4 font-bold tracking-tight text-left title-font text-4xl text-gray-800 tracking-tigh">
        ...
        <section className="text-gray-800 body-font py-4 px-2 bg-blue-100">
          <div className="container flex flex-col items-center px-5 py-12 mx-auto md:flex-row lg:px-8 bg-white rounded shadow-2xl mb-12">
              ...
              <div className="flex flex-wrap -mx-4 -mt-4 -mb-10 sm:-m-4">
                <div className="flex flex-col items-start p-4 mb-6 text-left md:w-1/2 md:mb-0">
                  ...
                  <div className="flex-grow">
                    <h2 className="mb-3 text-2xl font-bold text-gray-700 title-font">
                      Lorem ipsum
                    </h2>
                    <p className="text-base leading-relaxed mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit</p> <a href="#_" className="inline-flex items-center text-blue-700 md:mb-2 lg:mb-0 hover:text-blue-800">
                      Learn More
                ...
                <div className="flex flex-col items-start p-4 mb-6 text-left md:w-1/2 md:mb-0">
                  ...
                  <div className="flex-grow">
                    <h2 className="mb-3 text-2xl text-gray-700 title-font font-bold">
                      Lorem ipsum
                    </h2>
                    <p className="text-base leading-relaxed mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit</p> <a href="/" className="inline-flex items-center  text-blue-700 md:mb-2 lg:mb-0 hover:text-blue-800">
                      Learn More
                      <svg className="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} fill="currentColor">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M16.172 11l-5.364-5.364 1.414-1.414L20 12l-7.778 7.778-1.414-1.414L16.172 13H4v-2z" />
        ...
        <section className="text-gray-900 body-font bg-blue-100">
              ...
              <div className="p-4 md:w-1/3">
                <div className="h-full bg-white rounded-lg overflow-hidden shadow-2xl">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center flex-wrap"> <a href="#_" className="text-blue-700 inline-flex items-center md:mb-2 lg:mb-0">
                        Learn More
        ...
        <footer className="py-12 text-gray-800 bg-white">
          <div className="max-w-6xl m-auto flex flex-wrap justify-left">
            <div className="p-5 w-1/2 sm:w-4/12 md:w-3/12">
              <div className="text-xs uppercase text-gray-700 font-medium mb-6">
                Introduction
              </div>
